...
# 52 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC18Fxxxx_DFP/1.6.159/xc8\pic\include\proc\pic18f4550.h"
...
# 19 "C:/Program Files/Microchip/MPLABX/v6.20/packs/Microchip/PIC18Fxxxx_DFP/1.6.159/xc8\pic\include\pic18.h"
...
PORTD = 0xF0;
PORTD = (uint8_t)(PORTD & ((cmd << 4) & 0xF0));
...
PORTD = 0xF0;
PORTD = (uint8_t)(PORTD & ((dat << 4) & 0xF0));
...
{
for(uint16_t sms=0; sms < ((48000000/4)/1000); sms++);
...
{
for(uint16_t sus=0; sus < (48000000>>2)/1000000; sus++);
}
}
